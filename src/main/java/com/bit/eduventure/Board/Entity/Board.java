package com.bit.eduventure.Board.Entity;

import com.bit.eduventure.Board.DTO.BoardDTO;
...
public class Board {
    ...
    public BoardDTO EntityToDTO(){
        return BoardDTO.builder().boardNo(this.boardNo).boardTitle(this.boardTitle).boardWriter(this.boardWriter).boardContent(this.getBoardContent()).boardRegdate(this.getBoardRegdate().toString()).boardCnt(this.getBoardCnt())    .build();
    }
}
