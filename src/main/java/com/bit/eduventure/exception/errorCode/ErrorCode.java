...
public enum ErrorCode {
    ...
    STACK_OVER_FLOW(2004, "스택 오버 플로우. 백엔드 문제일 확률 높음"),
    ...
    URL_SYNTAX(3003, "서버 내부 API 요청시 오류 입니다."),

    RUN_TIME(9997, "예외입니다. 백엔드에서 세부화하든 프론트 문제든 난 몰라"),
    ILLEGAL_STATE(9998, "예외입니다. 백엔드에서 세부화하든 프론트 문제든 난 몰라"),
